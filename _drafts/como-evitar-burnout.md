...
O que você constrói hoje pode não ser mais relevante amanhã. Esse é um fato da indústria. Mesmo os melhores [softwares envelhecem](https://www.cs.drexel.edu/~yc349/CS451/RequiredReadings/SoftwareAging.pdf).
...
*   *[Refactoring: Improving the Design of Existing Code](https://www.amazon.com.br/Refactoring-Improving-Design-Existing-Code/dp/0201485672)*, de Martin Fowler.
...
É o pilar que mais depende de você. O sentimento de evolução vem com dedicação e disciplina.
No entanto, o ambiente pode atrapalhar em casos de:
